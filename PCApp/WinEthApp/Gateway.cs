...
namespace WinEthApp
{
    class Gateway
    {
        ...
        public void Update()
        {
                ...
                if (PacketIsValid(bytes))
                {
                    ...
                    switch (bytes[2])
                    {
                        ...
                        case 0x41:
                            ...
                            SCommHopeRFData commDataHopeRF = (SCommHopeRFData)Comm.FromBytes(withoutHeader, new SCommHopeRFData());
                            commDataHopeRF.HopeTXRSSI = GatewayData.HopeRXRSSI; // get received/gatewayed Hope RSSI
            ...
            // GUI update
            formMain.DisplayGatewayData(ReceivedHopeRFCounter, ReceivedPacketsCounter, GatewayData);
